  ...
  setup(__props) {
    ...
    const filteredLogs = computed(() => {
      ...
      return logs2.value.filter(
        (l) => {
          var _a, _b;
          return ((_a = l.message) == null ? void 0 : _a.toLowerCase().includes(q)) || ((_b = l.category) == null ? void 0 : _b.toLowerCase().includes(q));
        }
      );
    });
...
//# sourceMappingURL=logs-RoMTwXSJ.mjs.map
