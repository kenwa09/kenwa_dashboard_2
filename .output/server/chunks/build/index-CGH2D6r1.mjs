...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const vatThisMonth = computed(() => {
      var _a, _b;
      return (((_b = (_a = stats.value) == null ? void 0 : _a.thisMonth) == null ? void 0 : _b.revenue) || 0) * 0.21 / 1.21;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "accounting-page" }, _attrs))} data-v-310e0790><div class="page-header" data-v-310e0790><div data-v-310e0790><h1 class="page-title" data-v-310e0790>Boekhouding</h1><p class="page-sub" data-v-310e0790>Omzet en financieel overzicht</p></div><a href="/api/admin/accounting/export" class="export-btn" target="_blank" data-v-310e0790><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-310e0790><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" data-v-310e0790></path><polyline points="7 10 12 15 17 10" data-v-310e0790></polyline><line x1="12" y1="15" x2="12" y2="3" data-v-310e0790></line></svg> Exporteren (CSV) </a></div><div class="kpi-grid" data-v-310e0790><div class="kpi-card" data-v-310e0790><span class="kpi-label" data-v-310e0790>Omzet deze maand</span><span class="kpi-value" data-v-310e0790>\u20AC${ssrInterpolate(fmtCurrency(((_b = (_a = unref(stats)) == null ? void 0 : _a.thisMonth) == null ? void 0 : _b.revenue) || 0))}</span><span class="kpi-sub" data-v-310e0790>${ssrInterpolate(((_d = (_c = unref(stats)) == null ? void 0 : _c.thisMonth) == null ? void 0 : _d.orders) || 0)} bestellingen</span></div><div class="kpi-card" data-v-310e0790><span class="kpi-label" data-v-310e0790>Totale omzet</span><span class="kpi-value" data-v-310e0790>\u20AC${ssrInterpolate(fmtCurrency(((_f = (_e = unref(stats)) == null ? void 0 : _e.totals) == null ? void 0 : _f.revenue) || 0))}</span><span class="kpi-sub" data-v-310e0790>${ssrInterpolate(((_h = (_g = unref(stats)) == null ? void 0 : _g.totals) == null ? void 0 : _h.orders) || 0)} bestellingen</span></div><div class="kpi-card" data-v-310e0790><span class="kpi-label" data-v-310e0790>BTW (21%) deze maand</span><span class="kpi-value" data-v-310e0790>\u20AC${ssrInterpolate(fmtCurrency(unref(vatThisMonth)))}</span><span class="kpi-sub" data-v-310e0790>Over \u20AC${ssrInterpolate(fmtCurrency((((_j = (_i = unref(stats)) == null ? void 0 : _i.thisMonth) == null ? void 0 : _j.revenue) || 0) * 100 / 121))} excl. BTW</span></div><div class="kpi-card" data-v-310e0790><span class="kpi-label" data-v-310e0790>Shop aanmeldingen</span><span class="kpi-value" data-v-310e0790>${ssrInterpolate(((_k = unref(stats)) == null ? void 0 : _k.shopNotifyCount) || 0)}</span><span class="kpi-sub" data-v-310e0790>Ge\xEFnteresseerde bezoekers</span></div></div><div class="table-card" data-v-310e0790><div class="table-header" data-v-310e0790><h2 data-v-310e0790>Maandoverzicht</h2><span class="table-note" data-v-310e0790>Bedragen incl. BTW (21%)</span></div>`);
      if (!((_m = (_l = unref(stats)) == null ? void 0 : _l.monthly) == null ? void 0 : _m.length)) {
...
//# sourceMappingURL=index-CGH2D6r1.mjs.map
