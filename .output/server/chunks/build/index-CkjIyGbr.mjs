...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const stats = computed(() => {
      var _a;
      return (_a = overview.value) == null ? void 0 : _a.stats;
    });
    const trends = computed(() => {
      var _a;
      return (_a = overview.value) == null ? void 0 : _a.trends;
    });
    const activity = computed(() => {
      var _a;
      return ((_a = activityData.value) == null ? void 0 : _a.activity) || [];
    });
    const auditLogs = computed(() => {
      var _a;
      return ((_a = auditData.value) == null ? void 0 : _a.logs) || [];
    });
    const alerts = computed(() => {
      var _a;
      return ((_a = alertsData.value) == null ? void 0 : _a.alerts) || [];
    });
    const statItems = computed(() => {
      ...
      return [
        {
          label: "Gebruikers",
          value: (_b = (_a = stats.value) == null ? void 0 : _a.users) != null ? _b : 0,
          color: "#6366f1",
          bg: "rgba(99,102,241,0.1)",
          trend: ((_c = trends.value) == null ? void 0 : _c.usersThisWeek) || 0,
        ...
        {
          label: "Locaties",
          value: (_e = (_d = stats.value) == null ? void 0 : _d.locations) != null ? _e : 0,
          color: "#06b6d4",
        ...
        {
          label: "Deelverzoeken",
          value: (_g = (_f = stats.value) == null ? void 0 : _f.shares) != null ? _g : 0,
          color: "#8b5cf6",
          bg: "rgba(139,92,246,0.1)",
          trend: ((_h = trends.value) == null ? void 0 : _h.sharesThisWeek) || 0,
        ...
        },
        {
          ...
          value: (_j = (_i = stats.value) == null ? void 0 : _i.pageViews) != null ? _j : 0,
          color: "#10b981",
        ...
        {
          label: "Deelgebruik",
          value: (_l = (_k = stats.value) == null ? void 0 : _k.shareUses) != null ? _l : 0,
          color: "#f59e0b",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(statItems), (stat) => {
        var _a;
        _push(`<div class="stat-card" data-v-25056f6a><div class="stat-top" data-v-25056f6a><span class="stat-label" data-v-25056f6a>${ssrInterpolate(stat.label)}</span><div class="stat-icon" style="${ssrRenderStyle({ color: stat.color, background: stat.bg })}" data-v-25056f6a>${(_a = stat.icon) != null ? _a : ""}</div></div><div class="stat-bottom" data-v-25056f6a><span class="stat-value" data-v-25056f6a>${ssrInterpolate(stat.value)}</span>`);
        if (stat.trend) {
...
//# sourceMappingURL=index-CkjIyGbr.mjs.map
