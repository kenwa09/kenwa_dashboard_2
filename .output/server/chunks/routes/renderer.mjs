...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Kenwa Admin Dashboard"},{"name":"robots","content":"noindex, nofollow"},{"name":"theme-color","content":"#0f172a"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"titleTemplate":"%s — Kenwa Admin","title":"Admin Dashboard"};
