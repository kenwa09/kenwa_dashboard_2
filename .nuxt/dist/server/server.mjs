...
import { $fetch as $fetch$1 } from "C:/Users/ser_s/Desktop/Projecten/kenwa_dashboard/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/ser_s/Desktop/Projecten/kenwa_dashboard/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/ser_s/Desktop/Projecten/kenwa_dashboard/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/ser_s/Desktop/Projecten/kenwa_dashboard/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "C:/Users/ser_s/Desktop/Projecten/kenwa_dashboard/node_modules/defu/dist/defu.mjs";
import { hasProtocol, isScriptProtocol, joinURL, withQuery, parseURL, encodePath, decodePath } from "C:/Users/ser_s/Desktop/Projecten/kenwa_dashboard/node_modules/ufo/dist/index.mjs";
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-_Rik6qfH.js"),
  auth: () => import("./_nuxt/auth-DwntFs5g.js"),
  guest: () => import("./_nuxt/guest-LuOjPULZ.js")
};
...
const layouts = {
  admin: defineAsyncComponent(() => import("./_nuxt/admin-ClMPWXZE.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-Bb6mEtVT.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BfErl4no.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DKCltR3y.js"));
